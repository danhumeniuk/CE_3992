...
\caption{The Wii Balance Board may be an ideal candidate for a unique control system\\ Source: Adapted from \cite{wiiboard:19}}
\label{Wii}
\end{figure}
...
The first milestone to be completed during the fall will be the development of the graphical user interface for the web server. 

Balance Board API

Interfacing Nintendo controllers

Actuators on play area
